...
export default function Post({post}: { post: any }) {
    ...
    return (
        ...
        >
            ...
            <Text fontWeight={'700'} mt={'20px'} fontSize={'30px'} fontFamily={"'Rubik', sans-serif;"}
                  textAlign={'center'}>{post.title}</Text>
            <Text lineHeight={'16px'} mt={'10px'}>
                <Icon verticalAlign={'bottom'} mr={'5px'}>
                    <path fill="currentColor"
                          d="M18.2.7c-.8 0-1.4.5-1.4 1.3v3.1c0 .7.7 1.3 1.4 1.3s1.4-.5 1.4-1.3V2c0-.7-.7-1.3-1.4-1.3zM5.8.7C5 .7 4.4 1.3 4.4 2v3.1c0 .7.7 1.3 1.4 1.3s1.4-.5 1.4-1.3V2C7.3 1.3 6.6.7 5.8.7z"></path>
                    <path fill="currentColor"
