    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <Text fontSize={selectedLanguage==='ja'?'15px':''}   fontFamily={selectedLanguage==='ja'?"monospace":"'Rubik', sans-serif;"} mt={'10px'}>{selectedLanguage==='ja'?
                ...
                >
                    {Icons.map((v) => (
                        <Box
                            ...
                            alignItems={'center'}
                        >
                            <Text wordBreak={selectedLanguage==='ja'?'break-all':'normal'} fontWeight={"700"} mb={"7px"} textAlign={"center"}>{v.title}</Text>
