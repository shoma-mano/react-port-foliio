...
const Home: NextPage = () => {
    ...
    const Icons = [
        ...
        },
        {
            ...
            padding: 15,
            sentence: selectedLanguage === 'ja' ? "TypeScript,CompositionAPI,Piniaを用いての実務経験あり。" : "I used Vue3 with TypeScript, CompositionAPI, and Pinia."
        },
        {
            title: 'Angular',
            imgSrc: '/skill/angular.png',
            padding: 15,
            sentence: selectedLanguage === 'ja' ? "実務経験あり。JSフレームワークの基礎はAngularで学びました。" : 'I learned basic of JS framework by Angular.'
        },
        {
            title: 'NestJS',
            imgSrc: '/skill/nest.svg',
            padding: 15,
            sentence: selectedLanguage === 'ja' ? "個人開発でのTypeORM,GraphQL実装経験あり。" : 'I have used TypeORM and GraphQL in NestJS.'
        },
        {
            title: 'Rails',
        ...
        },
        {
            ...
            padding: 15,
            sentence: selectedLanguage === 'ja' ? "実務でのECSコード化経験あり" : 'I have deployed ECS using Terraform.'
        },
        {
            title: "AWS",
    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <Text fontFamily={"'Rubik', sans-serif;"} mt={'40px'} fontSize={'30px'} fontWeight={'700'}>
                    {selectedLanguage === 'ja' ? 'スキル' : 'Skill'}
                </Text>
                <Text fontSize={selectedLanguage === 'ja' ? '15px' : ''}
                      fontFamily={selectedLanguage === 'ja' ? "monospace" : "'Rubik', sans-serif;"}
                      mt={'10px'}>{selectedLanguage === 'ja' ?
                ...
                >
                    {Icons.map((v) => (
                        <Box
                            ...
                            alignItems={'center'}
                        >
                            <Text wordBreak={selectedLanguage === 'ja' ? 'break-all' : 'normal'} fontWeight={"700"}
                                  mb={"7px"} textAlign={"center"}>{v.title}</Text>
