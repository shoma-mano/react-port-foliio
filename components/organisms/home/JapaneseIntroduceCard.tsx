...
export const JapaneseIntroduceCard = ({
                                          position, name, englishName
                                      }: { position: string, name: string, englishName: string }) => {
    return (
        <>
            <Box transition={"all 20ms"} borderRadius={"8px"} marginTop={"20px"} boxShadow={"lg"} w={"630px"}
                 h={"380px"} bg={"white"}
                    ...
                    <Box display={"flex"} mt={"10px"} height={"100%"} flexDirection={"column"}
                        ...
                        <Box mb={"10px"} ml={"60px"}>
                            <Text color={"black"} mb={"10px"} fontWeight={"700"}
                                  fontSize={"24px"}>{position}</Text>
                            <Text fontWeight={"700"} fontSize={"48px"}>{name}</Text>
